...
# fix gems
mv dockerenv/var_original/lib/gems dockerenv
# cp -r dockerenv/opt/app/tmp dockerenv/var_original/apptmp
# rm -rf dockerenv/opt/app/tmp
# ln -s /var/apptmp dockerenv/opt/app/tmp
